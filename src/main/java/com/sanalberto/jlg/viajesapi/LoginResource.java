...
public class LoginResource {
    ...
    public Response loginAdmin(LoginDTO loginDTO) {
        ...
        String respuesta = loginServices.login(loginDTO.getCorreo(), loginDTO.getPassword());

// Si la respuesta no es nula creamos el token con el correo del usuario
        if (respuesta != null) {
            String token = generateJWT(loginDTO.getCorreo());
